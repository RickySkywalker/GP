...
public:
    ...
    void retranslateUi(QMainWindow *MenuWindow)
    {
        ...
        LoadGame->setText(QCoreApplication::translate("MenuWindow", "Load Game", nullptr));
        Exit->setText(QCoreApplication::translate("MenuWindow", "Exit", nullptr));
