...
public:
    ...
    void setupUi(QMainWindow *MenuWindow)
    {
        ...
        LoadGame->setGeometry(QRect(610, 460, 121, 81));
        LoadGame->setFont(font);
        Exit = new QPushButton(centralwidget);
        Exit->setObjectName(QString::fromUtf8("Exit"));
        Exit->setGeometry(QRect(480, 460, 131, 81));
        QFont font1;
    ...
    void retranslateUi(QMainWindow *MenuWindow)
    {
        ...
        LoadGame->setText(QCoreApplication::translate("MenuWindow", "USSR", nullptr));
        Exit->setText(QCoreApplication::translate("MenuWindow", "USA", nullptr));
